...
export const functions = {
    ...
    collect: new Func<[tokenId: bigint, recipient: string, amount0Max: bigint, amount1Max: bigint], {tokenId: bigint, recipient: string, amount0Max: bigint, amount1Max: bigint}, ([amount0: bigint, amount1: bigint] & {amount0: bigint, amount1: bigint})>(
        abi, '0x260e12b0'
    ),
    createAndInitializePoolIfNecessary: new Func<[tokenA: string, tokenB: string, fee: number, sqrtPriceX96: bigint], {tokenA: string, tokenB: string, fee: number, sqrtPriceX96: bigint}, string>(
        abi, '0x13ead562'
    ),
    decreaseLiquidity: new Func<[tokenId: bigint, liquidity: bigint, amount0Min: bigint, amount1Min: bigint, deadline: bigint], {tokenId: bigint, liquidity: bigint, amount0Min: bigint, amount1Min: bigint, deadline: bigint}, ([amount0: bigint, amount1: bigint] & {amount0: bigint, amount1: bigint})>(
        abi, '0x03a3f2ab'
    ),
    ...
    increaseLiquidity: new Func<[tokenId: bigint, amount0Desired: bigint, amount1Desired: bigint, amount0Min: bigint, amount1Min: bigint, deadline: bigint], {tokenId: bigint, amount0Desired: bigint, amount1Desired: bigint, amount0Min: bigint, amount1Min: bigint, deadline: bigint}, ([liquidity: bigint, amount0: bigint, amount1: bigint] & {liquidity: bigint, amount0: bigint, amount1: bigint})>(
        abi, '0x12d7b2c4'
    ),
