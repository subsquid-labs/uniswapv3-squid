...
export const functions = {
    ...
    observations: viewFun("0x252c09d7", "observations(uint256)", {"index": p.uint256}, {"blockTimestamp": p.uint32, "tickCumulative": p.int56, "secondsPerLiquidityCumulativeX128": p.uint160, "initialized": p.bool}),
    ...
    positions: viewFun("0x514ea4bf", "positions(bytes32)", {"key": p.bytes32}, {"_liquidity": p.uint128, "feeGrowthInside0LastX128": p.uint256, "feeGrowthInside1LastX128": p.uint256, "tokensOwed0": p.uint128, "tokensOwed1": p.uint128}),
    ...
    ticks: viewFun("0xf30dba93", "ticks(int24)", {"tick": p.int24}, {"liquidityGross": p.uint128, "liquidityNet": p.int128, "feeGrowthOutside0X128": p.uint256, "feeGrowthOutside1X128": p.uint256, "tickCumulativeOutside": p.int56, "secondsPerLiquidityOutsideX128": p.uint160, "secondsOutside": p.uint32, "initialized": p.bool}),
